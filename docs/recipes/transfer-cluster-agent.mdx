...
In this recipe, you will learn how to transfer ownership of a [cluster agent](/glossary/terms#cluster-agent) using the [spore-sdk](https://docs.spore.pro/resources/spore-sdk). Owning a cluster proxy doesn’t grant ownership of the referenced [cluster proxy](/glossary/terms#cluster-proxy) or the associated cluster.
