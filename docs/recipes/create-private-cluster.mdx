...
To create a public cluster that anyone can pay an unlocking fee to tag spores with it, check out: [Create a Public Cluster](/recipes/create-private-cluster).
