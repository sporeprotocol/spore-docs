...
A **Spore** can be thought of a valuable digital artifact. When you have multiple artifacts you want to organize together, you create a **Cluster**. 

Clusters can be of two types, Public or Private, allowing anyone or excusively the owner to assign a Cluster during the minting a new Spore, respectively.
