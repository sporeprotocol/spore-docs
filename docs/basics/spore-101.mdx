...
A **Spore** can be thought of a valuable digital artifact. When you have multiple artifacts you want to organize together, you create a **Cluster**. Importantly, each Spore can be linked with only one Cluster, while each Cluster can be associated with many Spores.
