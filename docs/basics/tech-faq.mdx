...
Not exactly. Spore is a Digital Object(DOB) that is not only non-fungible, resides fully on-chain but also establishes an intrinsic link between content and value.
